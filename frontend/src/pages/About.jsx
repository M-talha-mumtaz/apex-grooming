  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 max-w-4xl mx-auto text-center">
      ...
      <div className="space-y-8 text-zinc-300 font-light leading-relaxed text-lg text-left bg-zinc-900/40 p-10 border border-zinc-800">
        <p>
          Founded on the principles of precision and luxury, Apex Grooming represents the ultimate sanctuary for modern gentlemen and individuals who appreciate high-end personal care.
        </p>
        <p>
        ...
        <p>
          Every visit to Apex is designed to be an experience of absolute relaxation—from our complimentary premium beverages to the soothing hot towel treatments and the immaculate aesthetic of our New York-inspired black and gold salon.
        </p>
      </div>
    </div>
  );
